...
type
  ...
  private
    ...
    function PreencherAcbrNFe(var Nota: TNFCe): Boolean;
    function PreencherAcbrNFeEvento(var Nota: TNFCe): Boolean;
  public
    { Public declarations }
...
function TdmNfe.PreencherAcbrNFe(var Nota: TNFCe): Boolean;
var
  ValorTotalBCICMS,
  ValorTotalVLICMS,
  ValorTotalVLPIS,
...
function TdmNfe.PreencherAcbrNFeEvento(var Nota: TNFCe): Boolean;
begin
