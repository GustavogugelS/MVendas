...
begin
  ...
  Except on e:exception do
    raise Exception.Create('Erro de impressão:' + e.Message);
  end;
end;
//****************************************************
...
try
  ...
  iPRNTR.DrawBarCode( BarCodeConfig,StringToJString(texto));
    ...
    on e: exception do begin
      TDialogService.MessageDialog('Erro printBarCode=>'+e.Message,TMsgDlgType.mtError, [TMsgDlgBtn.mbOK], TMsgDlgBtn.mbOK, 0, nil);
  end;
end;
...
try
  ...
  iPRNTR.DrawPictureExt(imageConfig,BitmapToJBitmap(Imagem));
    ...
    on e: exception do begin
      TDialogService.MessageDialog('Erro printImage=>'+e.Message,TMsgDlgType.mtError, [TMsgDlgBtn.mbOK], TMsgDlgBtn.mbOK, 0, nil);
  end;
end;
end;
//****************************************************
